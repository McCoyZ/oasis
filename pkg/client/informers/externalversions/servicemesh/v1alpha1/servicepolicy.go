...
import (
	...
	versioned "zmc.io/oasis/pkg/client/clientset/versioned"
	internalinterfaces "zmc.io/oasis/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "zmc.io/oasis/pkg/client/listers/servicemesh/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServicemeshV1alpha1().ServicePolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServicemeshV1alpha1().ServicePolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&servicemeshv1alpha1.ServicePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *servicePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicemeshv1alpha1.ServicePolicy{}, f.defaultInformer)
}
