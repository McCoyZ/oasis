	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServicemeshV1alpha1().Strategies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServicemeshV1alpha1().Strategies(namespace).Watch(context.TODO(), options)
			},
		},
		&servicemeshv1alpha1.Strategy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *strategyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicemeshv1alpha1.Strategy{}, f.defaultInformer)
}
