...
const (
	nodeCPURequests                                 = "node.zmc.io/cpu-requests"
	nodeMemoryRequests                              = "node.zmc.io/memory-requests"
	nodeCPULimits                                   = "node.zmc.io/cpu-limits"
	nodeMemoryLimits                                = "node.zmc.io/memory-limits"
	nodeCPURequestsFraction                         = "node.zmc.io/cpu-requests-fraction"
	nodeCPULimitsFraction                           = "node.zmc.io/cpu-limits-fraction"
	nodeMemoryRequestsFraction                      = "node.zmc.io/memory-requests-fraction"
	nodeMemoryLimitsFraction                        = "node.zmc.io/memory-limits-fraction"
